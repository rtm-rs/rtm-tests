::inventory::submit!(super::IntegrationDefaultsTests {
    name: "indev",
    test_fn: indev,
    indev: Some(true),
});
...
pub fn indev() {
    ...
    let src = "src/integration/defaults/artifacts/001_sync.rs";
    let srcx = "src/integration/defaults/artifacts/001_sync.expanded.rs";
